    ...
    <div className="grid min-h-[calc(100vh-3.5rem)] place-items-center w-full px-4 py-8">
      {loading ? (
        ...
        <div className="w-full max-w-[500px] p-4 sm:p-8">
          ...
          <p className="my-4 text-sm sm:text-base leading-relaxed text-richblack-200">
            {!emailSent
          ...
          <div className="mt-6 flex items-center justify-between">
            <Link to="/login">
              <p className="flex items-center gap-x-2 text-richblack-5 text-sm hover:text-[#22c44c] transition-colors">
